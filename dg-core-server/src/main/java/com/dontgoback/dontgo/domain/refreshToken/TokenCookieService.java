...
public class TokenCookieService {
    ...
    private static final String REFRESH_TOKEN_API_PATH = "/api/token"; // 이전 TokenApiController 경로와 일치
    ...
    public void clearTokenCookies(HttpServletRequest request, HttpServletResponse response) {
        ...
        CookieUtil.deleteCookie(request, response, REFRESH_TOKEN_NAME, secureCookie);
    }
}