...
export const Dummys = {
  Feeds: [
    { feedId: 1, userId: 1, userName: "FrontDummy", feedType: "BLUE", createdAt: "1시간전", content: myText, likeCount: 0, commentCount: 0 },
    { feedId: 2, userId: 1, userName: "FrontDummy", feedType: "RED", createdAt: "1시간전", content: "contents Test", likeCount: 30, commentCount: 0 },
  ...
  Comments: [
    { commentId: 1, feedId: 1, userId: 1, userName: "FrontDummy", commentType: "RED", createdAt: "1시간전", content: myText, likeCount: 1, commentCount: 2 },
    { commentId: 2, feedId: 2, userId: 1, userName: "FrontDummy", commentType: "RED", createdAt: "1시간전", content: "실화냐?ㅋㅋ", likeCount: 4, commentCount: 0 },
